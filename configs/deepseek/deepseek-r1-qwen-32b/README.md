...
```bash
helm upgrade -i deepseek-r1-qwen-32b \
  --values configs/deepseek/deepseek-r1-qwen-32b/values.yaml \
  ./configs/chart
```
...
```bash
kubectl port-forward svc/deepseek-r1-qwen-32b 8080
```
...
```bash
kubectl port-forward svc/deepseek-r1-qwen-32b 8000
```
