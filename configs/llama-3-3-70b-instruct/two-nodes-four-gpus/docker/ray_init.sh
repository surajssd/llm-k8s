#!/bin/bash
# TODO: Remove this file when the new release of VLLM (version > 0.7.3) is available. See: https://github.com/kubernetes-sigs/lws/issues/386#issuecomment-2669282989
# When this file https://docs.vllm.ai/en/latest/getting_started/examples/multi-node-serving.html is also available at https://docs.vllm.ai/en/stable/getting_started/examples/multi-node-serving.html.
# The file will be available at: examples/online_serving/multi-node-serving.sh

# This file was created by running:
# curl -L -o ray_init.sh https://raw.githubusercontent.com/kubernetes-sigs/lws/refs/heads/main/docs/examples/vllm/build/ray_init.sh
# chmod +x ray_init.sh
